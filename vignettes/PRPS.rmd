...
If we only know selected features/traits with their weights but no comparable training data set,  and we would like to calculate classification score for a given tesing data set, what can we do?
...
the following is needed to be changed, maybe do not use any method as title at all
### 1) LPS
